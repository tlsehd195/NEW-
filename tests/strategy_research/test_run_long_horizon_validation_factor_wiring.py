...
class TestCandidateTables:
    ...
    (ADR-0051), plus the 2 Session 36 additions wired in afterward
    (`idiosyncratic_volatility`, ADR-0053; `combined_factor`, ADR-0054)
    -- 22 total -- no name collisions with each other, or with the 8
    ...
    _EXPECTED_NAMES = {
        ...
        "idiosyncratic_volatility", "combined_factor",
    }
    _PRE_EXISTING_NAMES = {
    ...
    def test_all_22_expected_names_present_exactly_once(self) -> None:
        module = _load_script()
